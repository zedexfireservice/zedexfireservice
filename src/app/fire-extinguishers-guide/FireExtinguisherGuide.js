    ...
    <div className="flex flex-col lg:flex-row items-start pt-12 gap-12 mb-20">
      ...
      <div className="lg:w-1/2 w-full">
        ...
        <div className="mt-8 p-5 bg-red-50 border border-red-100 rounded-lg">
          ...
          <p className="text-sm text-justify text-red-700">{safetyNote}</p>
        </div>
      </div>
    </div>
...
<section className="bg-red-50 py-20 rounded-lg">
  <div className="container mx-auto px-6 max-w-6xl">
    ...
    <div className="mb-16">
      <h2 className="  text-2xl md:text-3xl font-bold text-red-700 mb-6 flex items-center gap-3">
        <ShieldCheckIcon className="w-24 h-full md:w-8 md:h-8 text-red-700" />
        Why Choose Zedex Fire?
      </h2>
      ...
      <ul className="space-y-2 text-gray-700 text-sm list-disc list-outside ps-4">
