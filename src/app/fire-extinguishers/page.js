...
export default function FireExtinguisherPage() {
  ...
  const ABCChemicalFire = [
    ...
    {
      title: <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition duration-300 transform hover:scale-105">Get Pricing for ABC Extinguishers</button>
    },
    {
    ...
    {
      title: <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition duration-300 transform hover:scale-105">Get Pricing for CO2 Extinguishers</button>
    },
    {
    ...
    {
      title: <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition duration-300 transform hover:scale-105">Get Pricing for Water/Foam Extinguishers</button>
    },
    {
    ...
    {
      title: <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition duration-300 transform hover:scale-105">Get Pricing for Wet Chemical Extinguishers</button>
    },
    {
    ...
    {
      title: <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition duration-300 transform hover:scale-105">Get Pricing for Clean Agent Extinguishers</button>
    },
    {
    ...
    {
      title: <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition duration-300 transform hover:scale-105">Get Pricing for Automatic Extinguishers</button>
    }
  ];
      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              Need help choosing the right extinguisher for your specific needs in Delhi NCR? 
