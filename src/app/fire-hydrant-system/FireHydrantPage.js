   ...
   const FireHydrantsystem = [
    ...
    const FireHydranttypes3 = [
...

        {
            ...
            description: " Zedex Fire offers reliable maintenance and support services nationwide to keep your Fire Hydrant System in optimal working condition.",
        },
            ...
            <section className="px-4 py-12 md:px-20 bg-white text-gray-800">
                <div className="flex flex-col justify-around lg:flex-row items-center gap-10">
                    ...
                    <div className="lg:w-6/12">
                        <h1 className="text-3xl font-bold mb-4 text-center md:text-left"> Fire Hydrant System in Delhi NCR & India: Your Trusted Partner - Zedex Fire
                        </h1>

                        <p className="text-gray-700  text-justify md:text-left">
                            Protecting lives and property from fire hazards across  <strong>Delhi, the National Capital Region (NCR), and India</strong> requires robust and reliable fire suppression systems. At <strong>Zedex Fire</strong>, we are your trusted <strong>manufacturer, supplier, dealer, and installer of high-quality Fire Hydrant Systems</strong>. With years of expertise and a steadfast commitment to safety, we provide comprehensive solutions tailored to your specific needs, ensuring maximum protection for your premises throughout <strong>Delhi NCR and India</strong>.
                ...
                <div className="mt-12 space-y-10">
                    ...
                    <div className="row">
                        ...
                        <p className="text-gray-700  text-center ">
                            Don't compromise on fire safety, no matter your location. Protect your property and loved ones with a reliable <strong>Fire Hydrant System</strong> from <strong>Zedex Fire</strong>, your trusted partner across <strong>Delhi NCR and India</strong>.
                            We are committed to ensuring the safety and security of properties across <strong>Delhi, the NCR, and India</strong> with our superior <strong>Fire Hydrant System</strong> solutions. Choose Zedex Fire for peace of mind, nationwide.
